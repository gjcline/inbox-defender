...
const plans = [
  {
    name: "Personal",
    description: "For individual inboxes",
    price: 7,
    yearlyPrice: 69,
  ...
  },
  {
    ...
    includes: [
      ...
      "Multi-inbox, custom rules & thresholds",
      "CRM/Slack, daily+monthly digests",
      "Inbox Health score + outbound risk checks",
    ],
  },
  {
    name: "Enterprise",
  ...
  return (
    ...
    >
      ...
      <article className="text-center mb-6 pt-32 max-w-3xl mx-auto space-y-2 relative z-50">
        ...
        >
          Protect your inbox from unwanted cold emails with AI-powered filtering
        </TimelineContent>
            ...
            >
              <CardHeader className="text-left">
                <div className="flex justify-between">
                  ...
                  {plan.popular && (
                    <span className="bg-orange-500 text-white text-xs px-3 py-1 rounded-full h-fit">
                      Most Popular
                    </span>
                  )}
                </div>
