/*
  ...
  1. New Tables
    - `mailboxes`
      ...
      - `gmail_user_id` (text, nullable)
      - `provider` (text, default 'gmail')
      - `refresh_secret_key` (text, nullable)
      - `outreach_label_id` (text, nullable)
      - `last_history_id` (text, nullable)
      - `watch_expiration` (timestamptz, nullable)
